...
static const FreqPreset freqPresets[] = {
    {"160m Ham Band", 181000, 200000, STEPS_128, STEP_1_0kHz, MODULATION_USB,
     BK4819_FILTER_BW_NARROWER},
    {"80m Ham Band", 350000, 380000, STEPS_128, STEP_1_0kHz, MODULATION_USB,
     BK4819_FILTER_BW_NARROWER},
    {"40m Ham Band", 700000, 720000, STEPS_128, STEP_1_0kHz, MODULATION_USB,
     BK4819_FILTER_BW_NARROWER},
    {"30m Ham Band", 1010000, 1015000, STEPS_128, STEP_1_0kHz, MODULATION_USB,
     BK4819_FILTER_BW_NARROWER},
    {"20m Ham Band", 1400000, 1435000, STEPS_128, STEP_1_0kHz, MODULATION_USB,
     BK4819_FILTER_BW_NARROWER},
    {"16m Broadcast", 1748000, 1790000, STEPS_128, STEP_5_0kHz, MODULATION_AM,
     BK4819_FILTER_BW_NARROW},
    {"17m Ham Band", 1806800, 1816800, STEPS_128, STEP_1_0kHz, MODULATION_USB,
     BK4819_FILTER_BW_NARROWER},
    {"15m Broadcast", 1890000, 1902000, STEPS_128, STEP_5_0kHz, MODULATION_AM,
     BK4819_FILTER_BW_NARROW},
    {"15m Ham Band", 2100000, 2144990, STEPS_128, STEP_1_0kHz, MODULATION_USB,
     BK4819_FILTER_BW_NARROWER},
    {"13m Broadcast", 2145000, 2185000, STEPS_128, STEP_5_0kHz, MODULATION_AM,
     BK4819_FILTER_BW_NARROW},
    {"12m Ham Band", 2489000, 2499000, STEPS_128, STEP_1_0kHz, MODULATION_USB,
     BK4819_FILTER_BW_NARROWER},
    {"11m Broadcast", 2567000, 2610000, STEPS_128, STEP_5_0kHz, MODULATION_AM,
     BK4819_FILTER_BW_NARROW},
    {"CB", 2697500, 2799990, STEPS_128, STEP_5_0kHz, MODULATION_FM,
     BK4819_FILTER_BW_NARROW},
    {"10m Ham Band", 2800000, 2970000, STEPS_128, STEP_1_0kHz, MODULATION_USB,
     BK4819_FILTER_BW_NARROWER},
    {"6m Ham Band", 5000000, 5400000, STEPS_128, STEP_1_0kHz, MODULATION_USB,
     BK4819_FILTER_BW_NARROWER},
    {"Air Band Voice", 11800000, 13500000, STEPS_128, STEP_100_0kHz, MODULATION_AM,
     BK4819_FILTER_BW_NARROW},
    {"2m Ham Band", 14400000, 14800000, STEPS_128, STEP_25_0kHz, MODULATION_FM,
     BK4819_FILTER_BW_WIDE},
    {"Railway", 15175000, 15599990, STEPS_128, STEP_25_0kHz, MODULATION_FM,
     BK4819_FILTER_BW_WIDE},
    {"Sea", 15600000, 16327500, STEPS_128, STEP_25_0kHz, MODULATION_FM,
     BK4819_FILTER_BW_WIDE},
    {"Satcom", 24300000, 27000000, STEPS_128, STEP_5_0kHz, MODULATION_FM,
     BK4819_FILTER_BW_WIDE},
    {"River1", 30001250, 30051250, STEPS_64, STEP_12_5kHz, MODULATION_FM,
     BK4819_FILTER_BW_NARROW},
    {"River2", 33601250, 33651250, STEPS_64, STEP_12_5kHz, MODULATION_FM,
     BK4819_FILTER_BW_NARROW},
    {"LPD", 43307500, 43477500, STEPS_128, STEP_25_0kHz, MODULATION_FM,
     BK4819_FILTER_BW_WIDE},
    {"PMR", 44600625, 44620000, STEPS_32, STEP_6_25kHz, MODULATION_FM,
     BK4819_FILTER_BW_NARROW},
    {"FRS/GMRS 462", 46256250, 46272500, STEPS_16, STEP_12_5kHz, MODULATION_FM,
     BK4819_FILTER_BW_NARROW},
    {"FRS/GMRS 467", 46756250, 46771250, STEPS_16, STEP_12_5kHz, MODULATION_FM,
     BK4819_FILTER_BW_NARROW},
    {"LoRa WAN", 86400000, 86900000, STEPS_128, STEP_100_0kHz, MODULATION_FM,
     BK4819_FILTER_BW_WIDE},
    {"GSM900 UP", 89000000, 91500000, STEPS_128, STEP_100_0kHz, MODULATION_FM,
     BK4819_FILTER_BW_WIDE},
    {"GSM900 DOWN", 93500000, 96000000, STEPS_128, STEP_100_0kHz, MODULATION_FM,
     BK4819_FILTER_BW_WIDE},
    {"23cm Ham Band", 124000000, 130000000, STEPS_128, STEP_25_0kHz, MODULATION_FM,
     BK4819_FILTER_BW_WIDE},
};
